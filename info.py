...
DATABASE_LIMIT = environ.get("DATABASE_LIMIT", "100")
BOT_LIMIT = environ.get("BOT_LIMIT", "100")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+JnZ3tuWbYqlmNWU9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+QBisqBxzO-oyMmJl')
UPDATE_CHANNEL = int(environ.get('UPDATE_CHANNEL', -1001910147107))
