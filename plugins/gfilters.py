...
async def add_gfilter(client, message):
    ...
    await add_gfilter('gfilters', text, reply_text, btn, file_id, alert)
...
async def delete_gfilter(client, message):
    try:
        cmd, text = message.text.split(" ", 1)
    except:
        await message.reply_text(
            "<i>Mention the gfilter name you want to delete!</i>\n\n"
...
async def delete_all_gfilters(client, message):
    await message.reply_text(
