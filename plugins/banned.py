...
async def ban_reply(bot, message):
    ...
    await message.reply(f"Sorry, you are banned from using this service. \nBan Reason: {ban['ban_reason']}")
...
async def grp_bd(bot, message):
    ...
    k = await message.reply(
        text=f"CHAT NOT ALLOWED 🐞\n\nMy admins have restricted me from working here! If you want to know more about it, please contact support.\nReason: <code>{vazha['reason']}</code>.",
