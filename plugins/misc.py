...
async def showid(client, message):
    ...
    if chat_type == enums.ChatType.PRIVATE:
        ...
        await message.reply_text(
            ...
            f"🖥️ <b>Data Centre:</b> <code>{dc_id}</code>",
            quote=True
        )
...
async def who_is(client, message):
    status_message = await message.reply_text(
        "🔍 <i>Fetching user info...</i>"
    )
    await status_message.edit(
        "💡 <i>Processing user info...</i>"
    )
    from_user = None
    ...
    if from_user is None:
        return await status_message.edit("❌ <i>No valid user_id / message specified</i>")
    message_out_str = ""
    ...
    message_out_str += f"🖥️ <b>Data Centre:</b> <code>{dc_id}</code>\n"
